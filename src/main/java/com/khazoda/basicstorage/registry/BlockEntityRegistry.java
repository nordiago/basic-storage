...
public class BlockEntityRegistry {
  ...
  public static final BlockEntityType<CrateStockerBlockEntity> CRATE_STOCKER_BLOCK_ENTITY = Registry.register(
      Registries.BLOCK_ENTITY_TYPE, Identifier.of(Constants.BS_NAMESPACE, "crate_stocker_block_entity"),
      BlockEntityType.Builder.create(CrateStockerBlockEntity::new,
          BlockRegistry.CRATE_STOCKER_BLOCK).build());
