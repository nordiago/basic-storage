...
### This repository contains the source code for the Basic Storage mod for Minecraft Java Edition, available on [Modrinth](https://modrinth.com/mod/basicstorage) and [CurseForge](https://www.curseforge.com/minecraft/mc-mods/basic-storage).
